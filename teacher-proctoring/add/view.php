...
<div id="parents">
    <form action="." method="post" id="inputs">
                ...
                <div id="inputs">
                    ...
                    <select class="ui dropdown">
                        ...
                        foreach ($testTypes as $test) { ?>
                            <option
                                value="<?php echo $test['test_type_cde']; ?>"><?php echo $test['test_type_desc'] ?></option>

                            <?php $num += 1;
                        } ?>
                    </select>
                    <option>
                        "<?php echo $num; ?>"><?php echo $test['test_type_desc'] ?></option>
                    <?php $num += 1;
                    ?>
        </select>
        <!-- Test -->
        ...
        <select name="room_id" class="ui dropdown">
            ...
            <option
            "<?php echo $num; ?>"><?php echo $room['rm_nbr'] ?></option>
            <?php $num += 1;
            ?>
        </select>
