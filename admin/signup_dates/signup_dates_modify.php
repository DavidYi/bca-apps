...
<?php include 'view/sidebar.php'; ?>
    ...
    <div id="signup_dates_add">
        ...
        <form action="." method="post">
            <input type="hidden" name="action" value="modify_signup_dates">
            <input type="hidden" name="class_year" value="<?php echo htmlspecialchars($class_year);?>">
